                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="card border mb-3">
                                                            <div class="card-header bg-light">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox" name="permissions[{{ $module->id }}][]" value="access_user_support" id="access_user_support_{{ $module->id }}" onchange="toggleSubPermissions('{{ $module->id }}', 'user_support', this.checked)">
                                                            ...
                                                            <div class="card-body" id="user_support_sub_permissions_{{ $module->id }}" style="display: none;">
                                                                <h6 class="text-secondary mb-3">User Support Permissions:</h6>
                                                                <div class="form-check mb-2">
                                                                    <input class="form-check-input" type="checkbox" name="user_support_permissions[{{ $module->id }}][]" value="user_support_can_view" id="user_support_view_{{ $module->id }}">
                                                                    <label class="form-check-label" for="user_support_view_{{ $module->id }}">
                                                                        <i class="bx bx-show me-1"></i> User can view
                                                                    </label>
                                                                </div>
                                                                <div class="form-check mb-2">
                                                                    <input class="form-check-input" type="checkbox" name="user_support_permissions[{{ $module->id }}][]" value="user_support_can_update" id="user_support_update_{{ $module->id }}">
                                                                    <label class="form-check-label" for="user_support_update_{{ $module->id }}">
                                                                        <i class="bx bx-edit me-1"></i> User can update
                                                                    </label>
                                                                </div>
                                                                <div class="form-check mb-2">
                                                                    <input class="form-check-input" type="checkbox" name="user_support_permissions[{{ $module->id }}][]" value="user_support_can_expiry_update" id="user_support_expiry_{{ $module->id }}">
                                                                    <label class="form-check-label" for="user_support_expiry_{{ $module->id }}">
                                                                        <i class="bx bx-time me-1"></i> User expiry update
                                                                    </label>
                                                                </div>
                                                                <div class="form-check mb-2">
                                                                    <input class="form-check-input" type="checkbox" name="user_support_permissions[{{ $module->id }}][]" value="user_support_can_package_change" id="user_support_package_{{ $module->id }}">
                                                                    <label class="form-check-label" for="user_support_package_{{ $module->id }}">
                                                                        <i class="bx bx-package me-1"></i> User package change
                                                                    </label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox" name="user_support_permissions[{{ $module->id }}][]" value="user_support_can_add_days" id="user_support_days_{{ $module->id }}">
                                                                    <label class="form-check-label" for="user_support_days_{{ $module->id }}">
                                                        ...
                                                        <div class="card border">
                                                            <div class="card-header bg-light">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox" name="permissions[{{ $module->id }}][]" value="access_dealer_support" id="access_dealer_support_{{ $module->id }}" onchange="toggleSubPermissions('{{ $module->id }}', 'dealer_support', this.checked)">
                                                            ...
                                                            <div class="card-body" id="dealer_support_sub_permissions_{{ $module->id }}" style="display: none;">
                                                                <h6 class="text-secondary mb-3">Dealer Support Permissions:</h6>
                                                                <div class="form-check mb-2">
                                                                    <input class="form-check-input" type="checkbox" name="dealer_support_permissions[{{ $module->id }}][]" value="dealer_support_can_view" id="dealer_support_view_{{ $module->id }}">
                                                                    <label class="form-check-label" for="dealer_support_view_{{ $module->id }}">
                                                                        <i class="bx bx-show me-1"></i> Dealer can view
                                                                    </label>
                                                                </div>
                                                                <div class="form-check mb-2">
                                                                    <input class="form-check-input" type="checkbox" name="dealer_support_permissions[{{ $module->id }}][]" value="dealer_support_can_update" id="dealer_support_update_{{ $module->id }}">
                                                                    <label class="form-check-label" for="dealer_support_update_{{ $module->id }}">
                                                                        <i class="bx bx-edit me-1"></i> Dealer can update
                                                                    </label>
                                                                </div>
                                                                <div class="form-check mb-2">
                                                                    <input class="form-check-input" type="checkbox" name="dealer_support_permissions[{{ $module->id }}][]" value="dealer_support_can_expiry_update" id="dealer_support_expiry_{{ $module->id }}">
                                                                    <label class="form-check-label" for="dealer_support_expiry_{{ $module->id }}">
                                                                        <i class="bx bx-time me-1"></i> Dealer expiry update
                                                                    </label>
                                                                </div>
                                                                <div class="form-check mb-2">
                                                                    <input class="form-check-input" type="checkbox" name="dealer_support_permissions[{{ $module->id }}][]" value="dealer_support_can_package_change" id="dealer_support_package_{{ $module->id }}">
                                                                    <label class="form-check-label" for="dealer_support_package_{{ $module->id }}">
                                                                        <i class="bx bx-package me-1"></i> Dealer package change
                                                                    </label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox" name="dealer_support_permissions[{{ $module->id }}][]" value="dealer_support_can_add_days" id="dealer_support_days_{{ $module->id }}">
                                                                    <label class="form-check-label" for="dealer_support_days_{{ $module->id }}">
...
// Function to toggle sub-permissions visibility
